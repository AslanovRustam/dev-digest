...
export function VerdictBanner({
  ...
  /** Usage of the run behind this review (from the PR's run list); omitted → no line. */
  costUsd?: number | null;
  ...
  return (
    <div style={s.wrap}>
      ...
      <div style={s.main}>
        ...
        {costUsd !== undefined && (
          <div style={s.usage}>
            <RunCostBadge variant="full" costUsd={costUsd} tokensIn={tokensIn} tokensOut={tokensOut} />
          </div>
        )}
      </div>
      {score != null && (
