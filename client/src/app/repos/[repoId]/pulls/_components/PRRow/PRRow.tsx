...
export function PRRow({
  ...
  pr: PrMeta;
  repoId: string;
  /** owner/repo — deep-links the findings preview's file:line to GitHub. */
  ...
  return (
    ...
    >
      ...
      <div style={s.findingsCell}>
        {/* Open findings of the latest review; hover previews them. */}
      ...
      <div style={s.costCell}>
        {/* Sum of the latest review's runs; "—" until one finishes with a known cost. */}
