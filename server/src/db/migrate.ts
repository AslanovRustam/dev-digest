...
// CLI entrypoint. Compare as file URLs — a raw `file://${argv[1]}` never
// matches on Windows (backslashes, drive letter, unencoded spaces), which made
// the script a silent no-op there.
